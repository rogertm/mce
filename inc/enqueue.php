...
function mce_enqueue(){
	...
	// Fancybox
	wp_register_style( 'jquery.fancybox', t_em_get_css( 'jquery.fancybox', T_EM_CHILD_THEME_DIR_PATH .'/css', T_EM_CHILD_THEME_DIR_URL .'/css' ), '', t_em_theme( 'Version' ), 'all' );
	wp_enqueue_style( 'jquery.fancybox' );
	wp_register_script( 'jquery.fancybox', t_em_get_js( 'jquery.fancybox', T_EM_CHILD_THEME_DIR_PATH .'/js', T_EM_CHILD_THEME_DIR_URL .'/js' ), array( 'jquery' ), t_em_theme( 'Version' ), true );
